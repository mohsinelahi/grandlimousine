            ...
            <div className="page-content bg-white">
                ...
                <section className="about-content heading pb-5">
                    <div className="container">
                        ...
                        <p>With Grand Limousine, you can enjoy reliable transport that is both safe and affordable. The professional and knowledgeable chauffeurs operate all our cars. Also, our friendly staff offers you the best <a href="https://www.augustacarservice.com/" target="_blank" className="anchor" rel="noopener noreferrer"> customer </a> support. We provide you with the advanced facilities so you can enjoy the ride to the fullest.</p>
