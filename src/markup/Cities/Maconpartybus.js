            ...
            <div className="page-content bg-white">
                ...
                <section className="section-full cities-sec-two">
                    <div className="cities-content heading">
                        ...
                        <p>Our Party Bus rental is an excellent transport solution for your next event. Macon Tours provides quality level group transportation for a night on the town and exotic sightseeing for all <a href="https://www.facebook.com/carservicehouston/" target="_blank" className="anchor" rel="noopener noreferrer"> occasions </a>, including birthdays, weddings, parties, and more.</p>
                                ...
                                <div className="car-services">
                                    <div className="row">
                                        <div className="col-md-4 border-right border-bottom">
                                            <h4>Party Bus Macon</h4>
                                            <p>Grand Limousine has employed the most professional and motivated personnel supported by the latest technological facilities. We provide all forms of Chauffeur  & Luxury Bus, as well as a driver only, for both families and business people who need to move from one meeting to the next.</p>                                        
                                            </div>
                                        <div className="col-md-4 border-right border-bottom">
