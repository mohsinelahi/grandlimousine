                ...
                <section className="section-full cities-sec-two">
                    <div className="cities-content heading">
                        <div className="container">
                            ...
                            <p>Kentucky Car Service owns and has been operating multiple new rides. We have a wide range of vehicles including limousines, 56 Passenger Motor Coaches along with SUVs, Sedans, and Hybrids, executive Vans, luxury mini Buses for carrying up to 39 <a href="https://www.facebook.com/carservicehouston/" target={"_blank"} className={"anchor"} rel="noopener noreferrer"> passengers</a>. Also, we have party buses for 12-25 passengers.</p>
                            ...
                            <p>No one in the business can beat the competitive rate and premium quality service we provide. Check out why people throughout Kentucky and in the surrounding area of the country prefer choosing us over anyone else for their <Link to={"/locations/savannah-party-bus/"} target={"_blank"} className={"anchor"} rel="noopener noreferrer"> transport </Link>.</p>
