                                ...
                                <div className="col-md-5">
                                    <div className="right">
                                        <div className="allegiant-stadium text-center">
                                            <img src={Destinimg1} alt="Jacksonville"></img>
                    ...
                    <div className="cities-content heading">
                        <div className="container">
                            ...
                            <ul className="atlanta-serivces">
                                <li> <Link to={"/locations/destin-car-service/"} rel="noopener noreferrer"> Destin Car Service </Link> </li>
                                <li> <Link to={"/locations/destin-limousine/"} rel="noopener noreferrer"> Destin Limousine </Link> </li>
                                <li> <Link to={"/locations/destin-party-bus/"} rel="noopener noreferrer"> Destin Party Bus </Link> </li>
                            </ul>
                            ...
                            <p>We offer our Car Service Destin worldwide, and we are one of the trusted names in the business. We leave you no chance to find fault with our town car services. It is a <a href="https://www.augustacarservice.com/augusta-limousine/" target={"_blank"} className={"anchor"} rel="noopener noreferrer"> seamless </a> transport solution that you can enjoy with our Grand Limousine. Just one phone call and that is all. On the ground of transportation, we solve your problems with a <Link to={"/covid-19-whats-next/"} className={"anchor"}> finger </Link> click!</p>
                            ...
                            <div className="contact-local-teams">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 text-center">
                                        <h5>Local Team</h5>
                                        <ul>
                                            <li>Address: <a href="https://goo.gl/maps/LK9LefrMVzEWL7pM9" rel="noopener noreferrer">531 Juanita Ave, Destin, FL 32541, Florida, USA</a> </li>
