...
class Augustalimousine extends Component {
    render() {
        return (
                ...
                <section className="section-full section-top">
                    <div className="container">
                        <div className="section-head inner-section-head text-black text-center">
                            <h2 className="box-title">Augusta Limousine</h2>
                            <div className="dlab-separator bg-primary"></div>
                            <p> Augusta’s Leading Provider of High-Quality Chauffeur Limousine Service in Augusta, GA</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="section-full cities-sec-two">
                    <div className="cities-content heading">
                        <div className="container">
                            ...
                            <h4>Augusta Limo Services </h4>
                            <p>Augusta Limos Masters Transportation. Your Best Transportation from Atlanta to Augusta for Masters, Door-to-Door Transportation to Augusta National Golf Club. If you are planning your transportation from Atlanta to the Masters in Augusta, you have found the provider of the best door-to-door transportation to Augusta National Golf Club or your place of lodging in Augusta. For more than 15 years, travelers experienced the dependable luxury transportation services provided by Augusta Limousine Corporate Transportation.</p>
                                                    
                            <h4>Augusta Limousine Services Augusta, GA (AGS)</h4>
                            <p>You, too, can enjoy the comfort and style of a late model vehicle maintained for your safety. Equipped to service golf professionals as well as their families, friends, and fans, Our Corporate transportation has a limousine that will meet your needs and allow you to relax and leave the driving to our professional chauffeurs. Each vehicle equipped with WiFi and bottled water stocked with amenities that you may request when booking your transportation to the Augusta National Golf Club.</p>
                            <p>Select the Option that Best Suits Your Transportation Needs to Attend the 2016 Masters at Augusta National Golf Club. Whether you are traveling as an individual, couple, family, or group, Augusta Limousine Transportation, has a vehicle equipped to provide a smooth, stress-free ride from the Atlanta Airport and surrounding Georgia areas to Augusta. Special Vehicle Rental Rates from Atlanta to Augusta, Savannah to Augusta, Macon to Augusta, Columbia SC, Columbus Ga. Click the button above to get a quote, or should you need to make custom arrangements, just give us a call.</p>
                        ...
                        <div className="container">
                            <div className="premium-luxury">
                                <div className="section-head text-black text-center">
                                    <h2 className="box-title">Our Limo Service in Augusta</h2>
                                    <div className="dlab-separator bg-primary"></div>
                                </div>
                    ...
                    <div className="cities-content heading">
                        <div className="container">
                            <div className="contact-local-teams">
                                <div className="section-head text-black text-center">
                                    <h2 className="box-title">Contact our local team in North Augusta SC – Evans – Aiken – Martinez – Thomson - Atlanta</h2>
                                    <div className="dlab-separator bg-primary"></div>
                                    <p>Augusta Limousine & Private chauffeur </p>
                                </div>
                                <div className="row">
...
export default Augustalimousine;