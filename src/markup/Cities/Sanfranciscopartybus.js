                                ...
                                <div className="col-md-5">
                                    <div className="right">
                                        <div className="allegiant-stadium text-center">
                                            <img src={Atlantalimousine} alt="San Francisco Limousine and Private Chauffeur Service"></img>
                            ...
                            <div className="contact-local-teams">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 text-center">
                                        <h5>Local Team</h5>
                                        <ul>
                                            <li>Address: <a href="https://goo.gl/maps/Dkscp4jQCSftW54Y6" rel="noopener noreferrer">240 S Main St, Los Angeles, CA 90012, California, USA</a> </li>
