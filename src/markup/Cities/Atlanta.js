                ...
                <section className="section-full cities-sec-two">
                    <div className="cities-content heading">
                        <div className="container">
                            ...
                            <p>Check out our entire website to unveil the secrets of why people in Atlanta and the <a href="https://www.augustacarservice.com/" target="_blank" rel="noopener noreferrer">surrounding</a> area prefer us. Call us at <a href="tel:4044244499" className="anchor"> (404) 424-4499 </a>  to contact us or if you have any <Link to={"/"} className="anchor" rel="noopener noreferrer"> queries </Link> about our car and limousine services.</p>                        
