...
class Houstonpartybus extends Component {
    render() {
        return (
                ...
                <section className="section-full section-top">
                    <div className="container">
                        <div className="section-head inner-section-head text-black text-center">
                            <h2 className="box-title"> Houston Party Bus </h2>
                            <div className="dlab-separator bg-primary"></div>
                            <p> The World’s Leading Provider of High-Quality Chauffeured Party Bus Service in Houston, TX</p>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-7">
                                    <div className="left">
                                        <h4> Houston Private Bus </h4>
                                        <p> <strong>Houston Party Bus – </strong>  Book Direct Since 2007 -You and your friends can enjoy Houston Party Bus Premium Rental Packages that include graduation parties, prom, birthdays, game-day, bachelor/bachelorette, quinceañeras, retirement parties, and special anniversaries. The most utilized of these services are the bachelor and bachelorette parties.</p>
                                        <p>Houston Party Bus fleet of the latest models of buses can hold up to 10 to 28 passengers with so many great party bus features. They include:</p>
                                            <ul>
                                                <li>State-of-the-art climate control</li>
                                                <li>Sunroofs for stargazing</li>
                                                <li>Posh leather seating and decorative embellishment</li>
                                                <li>Strobe lights and ambient lighting</li>
                                                <li>Perimeter seating arrangement for dancing</li>
                                                <li>Décor and furnishings tailored to the theme of your party</li>
                                                <li>Flat-screen TVs</li>
                                                <li>Advanced surround sound</li>
                                                <li>iPod & phone AUX jacks</li>
                                            </ul>
                    ...
                    <div className="cities-content heading">
                        <div className="container">
                            ...
                            <p>"I’m just so happy I’ve found the best party bus rental near me. So happy. Cheryl B. Bachelor Party Ideas How much is a Party Bus, you ask? Well, Party Bus rental prices are by the itinerary of services offered by the company, and bachelor parties usually have big stakes when it comes to this. The packages are tailored for different situations, whether it is the last night of your single life or a day out with your friends. Limo Party Bus prices are lower when you split t among your group friends or as you enjoy a sports-themed party. The royal treatment offered is above any other and includes VIP treatment, just as with the Bachelorette Parties plus concierge service. And by the way, Party Bus rentals are perfect for these scenarios. Our popular bachelor party <a href="https://www.facebook.com/carservicehouston/" target="_blank" className="anchor" rel="noopener noreferrer"> itineraries </a> include:</p>
                                ...
                                <li>Nightclubs & karaoke</li>
                                <li>Party cruises</li>
                                <li>Massage & spa therapy sessions</li>
                                <li>Hotel experiences</li>
                                <li>Concerts</li>
                                <li>Cigar lounges & whiskey bars</li>
                                <li>Poker nights</li>
                                <li>Paintball& go-kart racing</li>
                                <li>Shooting range parties</li>
                                <li>Comedy clubs</li>
                                <li>Dinner tours</li>
                            </ul>
                            <h4 className="text-center">Woodlake – West University – Memorial – Piney Point Village –Boulevard Oaks</h4>
                        </div>
                    </div>
                </section>
...
export default Houstonpartybus;