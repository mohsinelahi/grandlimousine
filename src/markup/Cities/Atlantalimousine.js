...
class Atlantalimousine extends Component {
    render() {
        return (
                ...
                <section className="section-full section-top">
                    <div className="container">
                        <div className="section-head inner-section-head text-black text-center">
                            <h2 className="box-title">Atlanta Limousine</h2>
                ...
                <section className="section-full atlanta-two">
                    <div className="atlanta-content heading">
                        <div className="container">
                            ...
                            <p>You may think booking a limo is very expensive for you. However, it’s not always necessary. It’s because there are so many options available. ATL Limousine offers you a wide range of vehicles such as a town car and specialty units, including a Party Bus. We have an affordable pricing range for the premier limo.</p>
                            ...
                            <ul><li>The Lincoln Stretch Limo</li></ul>

                            <p>One of the most popular services in Atlanta that people take on rent. You will get at least one from your nearest car service company. It is suitable for your needs on every occasion, such as a wedding, prom, or anything else. It can accommodate 5–10 passengers.</p>

                            <ul><li>Chrysler 300 Limo</li></ul>

                            You will feel like a celebrity when you ride Chrysler 300 Limo. This vehicle comes with luxury accommodation and seats for 6 to 12 passengers.

                            <h4>Experience Airport Chauffeur Service in ATL</h4>
...
export default Atlantalimousine;