...
import Grapevinetable from '../Element/Grapevinetable';


class Grapevine extends Component {
    render() {
        return (
                ...
                <section className="section-full section-top">
                    <div className="container">
                        <div className="section-head inner-section-head text-black text-center">
                            <h2 className="box-title">Grapevine Car Service</h2>
