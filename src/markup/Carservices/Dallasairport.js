...
class Dallasairport extends Component {
    render() {
        return (
                ...
                <section className="section-full services-main">
                    <div className="services-content heading">
                        <div className="container">
                            ...
                            <p>Here at Grand Limousine, we have designed our limousine and car services with great care and attention. Whether you need our assistance for an airport transfer, private tour, particular event transfer, or limousine tour, we are here to help. Whether you are in Arlington or Grapevine, call us on <a href="tel:404204244499" className="anchor" rel="noopener noreferrer"> (404) 424-4499</a>.</p>

                            <h4>Dallas Corporate Transportation</h4>
                            <p>We are one of the most trusted moderate and ready to take you to your destination with the latest fleet and state-of-the-art vehicle technology. We offer an all-inclusive limousine and car service, including cars, Sprinter, Bus, stretched limousine, and more. You can enjoy customized town car services for a single or large group for travel and tour in <strong> Dallas </strong>  with us.</p>
                            <p>All our car services are available at reasonable rates, and you will get a variety of options from us. We take pride in our <a href="https://sites.google.com/view/grand-limousine" target="_blank" className="anchor" rel="noopener noreferrer"> customer </a> services and offer some of the most beautiful grand limousines to you. Our services are available in the Dallas and metropolitan areas, including the rural territory areas.</p>
