...
class Bookyourlimousine extends Component {
    render() {
        return (
           <div className="book-your-car text-center">
                ...
                <h5> Call now at <a href="tel:4044244499"> (404) 424-4499 </a> to book your limousine! </h5> 
            </div>
        )
    }
}
...
export default Bookyourlimousine;