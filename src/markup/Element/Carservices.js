	...
	render(){
        ...
        <div className="car-services">
            <div className="row">
                ...
                <div className="col-md-4 border-right ">
                    <h4>Prom</h4>
                    <p>A prom day is something that every teenager wants to be unique. And nothing is better than making a statement entry in a luxury limousine. You can start enjoying the night even before the party begins. With your limo or party bus, you will enjoy the ride like a prom king or queen.</p>
                </div>
                <div className="col-md-4">
                    <h4>Bachelor / Bachelorette</h4>
                    <p>A bachelor party is the last celebration of a bachelor’s life, and you want to spend it with your friends. You want it to be a lifetime experience. Choose our party buses as this is the best means of transport to travel around the different party spots no matter where you are. Houston Limo offers the most awesome party buses in your area.</p>
                </div>
            </div>
        </div>
