...
const aboutBlog = [
    {
        image : require('./../../images/services/service1.jpg'),
        title : 'WEDDING',
    ...
    {
		image : require('./../../images/services/service2.jpg'),
    ...
    {
		image : require('./../../images/services/service3.jpg'),
    ...
    {
		image : require('./../../images/services/service4.jpg'),
	...
	{
		image : require('./../../images/services/service5.jpg'),
	...
	{
		image : require('./../../images/services/service6.jpg'),
							...
							<div className="blog-post dez-blog">
								...
								<div className="dlab-info">
									...
									<div className="dlab-post-title ">
										<h5 className="post-title"><Link to={"./"}>{item.title}</Link></h5>
									</div>
									...
									<div className="dlab-post-meta">
										<ul>
											...
											<li className="clickhere"> <Link to = {"./"}>Click Here</Link> </li>
										</ul>
									</div>
								</div>
							</div>
